...
let s:bg = { 'gui': '#1d2021', 'cterm': 234 }
let s:fg = { 'gui': '#ebe5d8', 'cterm': 146 }
let s:invisibles = { 'gui': '#5F7F7A', 'cterm': 60 }
let s:comments = { 'gui': '#81858c', 'cterm': 60 }
let s:selection = { 'gui': '#343b51', 'cterm': 60 }
let s:guides = { 'gui': '#4e5579', 'cterm': 60 }
let s:caret = { 'gui': '#dea41d', 'cterm': 220 }
let s:line_numbers = { 'gui': '#67776A', 'cterm': 60 }
let s:line_highlight = { 'gui': '#181108', 'cterm': 234 }
let s:white = { 'gui': '#ECEFF4', 'cterm': 231 }
let s:black = { 'gui': '#000000', 'cterm': 232 }
let s:red = { 'gui': '#db4048', 'cterm': 203 }
let s:orange = { 'gui': '#d47026', 'cterm': 209 }
let s:yellow = { 'gui': '#e3bd6b', 'cterm': 11 }
let s:green = { 'gui': '#7cb074', 'cterm': 2 }
let s:cyan = { 'gui': '#4b7cad', 'cterm': 117 }
let s:blue = { 'gui': '#5989d4', 'cterm': 111 }
let s:paleblue = { 'gui': '#9CB9CD', 'cterm': 152 }
let s:purple = { 'gui': '#A28DBE', 'cterm': 176 }
let s:brown = { 'gui': '#83553c', 'cterm': 137 }
let s:pink = { 'gui': '#E5A3A6', 'cterm': 204 }
let s:violet = { 'gui': '#C09EBD', 'cterm': 139 }
let s:neon = { 'gui': '#bf4957', 'cterm': 10 }
